    ...
    setTimeout(() => {
        ...
        if (toggleSelectModeBtn) {
            ...
            bulkDeleteBtn.addEventListener('click', async () => {
                ...
                if (!confirm(\Bạn có chắc chắn muốn xóa \ chương đã chọn? Hành động này không thể hoàn tác.\)) return;
                ...
                try {
                    ...
                    if (data.success) {
                        if (typeof showToast === 'function') showToast(\Đã xóa \ chương thành công!\);
